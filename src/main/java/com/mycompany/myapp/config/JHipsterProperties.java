...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "amarapp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "amarapp API";

        private String description = "amarapp API documentation";
